...
class DataLibrary{
    ...
    private val allObjectLibrary: MutableList<ObjectLibrary> = mutableListOf(
        ...
        Book(12, "Детроит", true, 82, "Дмитрий Глуховский"),
        Book(13, "Нью-Джерси", true, 124, "Роберт Грин"),
        Newspaper(14, "Газета Дня", true, 11, month.monthes[4].toString()),
        Book(15, "Нос", true, 52, "Николай Гоголь"),
        Book(16, "Белый Клык", true, 544, "Иван Гончаров"),
